...
namespace uapi\userapi\components;
 ...
 *
 * ~~~
 * Yii::$container->set('uapi\userapi\components\Configs',[
 *     'db' => 'customDb',
 *     'userTable' => 'user',
 * ]);
 * ~~~
...
class Configs extends \yii\base\Object
{
    ...
    public static function instance()
    {
        if (self::$_instance === null) {
            $type = ArrayHelper::getValue(Yii::$app->params, 'uapi.userapi.configs', []);
